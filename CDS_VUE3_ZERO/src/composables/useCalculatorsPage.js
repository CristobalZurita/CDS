...
export function useCalculatorsPage() {
  ...
  const calculatorItems = computed(() => {
    ...
    {
      label: 'Código de Resistencias THT',
      description: 'Identifica resistencias THT/DIP por bandas de color.',
    ...
    {
      label: 'Código de Resistencias SMD',
      description: 'Decodifica resistencias SMD de 3/4 dígitos, EIA-96 y notación R.',
      path: '/calc/smd-resistor',
      icon: 'fa-solid fa-microchip',
      image: '/images/calculadoras/resistencia_smd.webp',
      category: 'Identificación',
      popular: false,
    },
    {
