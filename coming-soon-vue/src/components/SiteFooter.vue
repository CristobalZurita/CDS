...
<style scoped>
.site-footer {
  background: var(--cds-footer-bg);
  color: var(--cds-white);
  --footer-safe-left:  clamp(1rem, 6vw, 4rem);
  --footer-safe-right: clamp(1rem, 6vw, 4rem);
...
.site-footer-legal {
  ...
  padding-top: 1.2rem;
  border-top: 1px solid color-mix(in srgb, var(--cds-white) 10%, transparent);
  display: flex;
  flex-wrap: wrap;
